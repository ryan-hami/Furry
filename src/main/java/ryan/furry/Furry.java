...
public class Furry implements ModInitializer {
    ...
    public static void shell(XYZUV[] verticies, Vector3f transNorm, VertexConsumer vertexConsumer, int light,
        ...
        for (int i = 0; i < n; ++i) {
            ...
            XYZUV x00 = a.add(dba.mul(t00));
            XYZUV x01 = a.add(dba.mul(t01));
            XYZUV x10 = d.add(dcd.mul(t00));
            XYZUV x11 = d.add(dcd.mul(t01));
            ...
            for (int j = 0; j < m; ++j) {
                ...
                XYZUV v00 = x00.add(dx10x00.mul(t10));
                XYZUV v01 = x00.add(dx10x00.mul(t11));
                ...
                for (int k = 0; k < l; ++k) {
                    ...
                    XYZUV s00 = v00.add(m.sub(v00).mul(t));
                    XYZUV s01 = v01.add(m.sub(v01).mul(t));
                    XYZUV s10 = v10.add(m.sub(v10).mul(t));
                    XYZUV s11 = v11.add(m.sub(v11).mul(t));
